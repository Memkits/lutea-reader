    ...
    'app.comp.container $ %{} 'FileEntry
      :defs $ {}
        ...
        'pattern-lines $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def pattern-lines (new js/RegExp |\n\n+)
          :examples $ []
          :schema $ :: 'Dynamic
        'pattern-spaces $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def pattern-spaces (new js/RegExp |\s+)
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
